...
// 					label.innerHTML = '<b>' + String.fromCharCode(reverseLookupText[n + ',' + i]) + '</b>' + '<br /><br />' +  n.substr(0,1) +'<div name="OCTAVE_LABEL" value="' + i +  + (__octave + parseInt(i)) + '</div>' + (n.substr(1,1)?n.substr(1,1):'')
// 					+'<br/><br/><br/><span >'+'Perde:'+perdeler[n]+'</span>';
// 					}else{
...
// 					}
				   ...
				   // thisKey.setAttribute('')
					...
					//thisKey.removeEventListener(evtListener[0],(function(_temp) { return function() { fnPlayKeyboard({keyCode:_temp}); } })(reverseLookup[n + ',' + i]));	
	 ...
	 var k=e.keyCode;
		...
		switch(k) {
			...
			case 76:
				...
				//alert(document.getElementById('makam').value);
				//console.log(document.getElementById('makam').value);
